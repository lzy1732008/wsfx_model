...
def train():
    ...
    train_1,train_2,train_output = p.setinputdata(config.seq_length_1, config.seq_length_2, flag = 0)
    print('train1_shape:',train_1.shape)

    # print(train_3)
    val_1, val_2,val_output = p.setinputdata(config.seq_length_1, config.seq_length_2, flag = 1)
