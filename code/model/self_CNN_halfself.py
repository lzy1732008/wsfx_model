    ...
    def cnn(self):
        ...
        with tf.name_scope("cnn1"):
            ...
            with tf.variable_scope("cnn-var1"):
                conv = tf.layers.conv1d(self.input_x_1, self.config.num_filters, self.config.kernel_size,
                                        name='conv')  # (?,26,256)
        ...
        with tf.name_scope("cnn3"):
            ...
            with tf.variable_scope("cnn-var3"):
                conv = tf.layers.conv1d(t2, self.config.num_filters, self.config.kernel_size,
                                        name='conv')  # (?,26,256)
                # global max pooling layer
